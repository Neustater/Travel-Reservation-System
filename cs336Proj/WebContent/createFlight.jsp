...
<body>
	...
	<div>
		...
		<form method="post" action= "createFlight2.jsp">
			<table class="login">
				<tr>
					<td><label for="Flight_number">Flight number</label></td>
					<td><input id="Flight_number" type="text" name="Flight_number" required></td>
				</tr>
				<tr>
				...
				<tr>
					<td><label for="Biz_class_price">Biz class price</label></td>
					<td><input id="Biz_class_price" type="text" name ="Biz_class_price"required></td>
				</tr>
				<tr>
					<td><label for="Econ_class_price">Econ class price</label></td>
				...
				<tr>
					...
					<td><input id="Flight_date" type="date" name="Flight_date"required></td>
				</tr>
				<tr>
					<td><label for="Return_date">Landing date</label></td>
					<td><input id="Return_date" type="date" name="Return_date"required></td>
				</tr>
				<tr>
